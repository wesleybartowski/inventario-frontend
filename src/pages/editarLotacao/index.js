        ...
        if (i == 0) {
            ...
            dadosnovos=lista.map((function(item){
                if (item.id==id){
                    ...
                    return {
                        id:item.id,
                        data_lotacao:item.data_lotacao,
            ...
            <div className="principal">
                ...
                <section className="form-cadastro">
                    <form onSubmit={salvardados}>
                        <label>Data Lotação</label>
                        <input placeholder="Data Lotação"
                            type="date"
                            value={data_lotacao}
                            onChange={e => setData_Lotacao(e.target.value)}
